  ...
  const handleAddonClick = (e, project) => {
    ...
    return (
      <div className="relative min-h-screen  md:pt-20">
        ...
        <section>
          <div className="sticky top-[70px] z-30  w-full rounded-2xl bg-[#0B0F14]/90  shadow-2xl backdrop-blur-xl">
                  ...
                  {categories.map(({ name, icon: Icon }) => {
                    ...
                    return (
                      <button
                       ...
                       className="flex flex-shrink-0 cursor-pointer items-center gap-2 rounded-[8px] bg-white/[0.04] px-3.5 py-3 text-[11px] font-medium transition-all hover:bg-white/[0.08]"
                      >
                        <Icon
                          size={13}
