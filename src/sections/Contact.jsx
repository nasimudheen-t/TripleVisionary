...
export default function Contact() {
  const [formData, setFormData] = useState({ name: '', email: '', projectType: 'Commercial Ads', message: '' });
  ...
  return (
    <section id="contact" className="relative py-24 bg-[#0B0F14] overflow-hidden">
      ...
      <div className="container mx-auto px-6 max-w-6xl relative z-10">
        ...
        <div className="flex flex-col items-center justify-center text-center mb-16">
          ...
          <p className="text-sm md:text-base text-[#C6D3E1]/70 max-w-xl font-light">
            Initialize transmission. Connect with our producers to establish timeline targets and specs.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
            ...
            <GlassCard className="p-6 md:p-8 bg-[#10151C]/90 border border-white/10 scanlines">
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div className="flex flex-col gap-1.5">
                  <label htmlFor="name" className="font-mono text-[9px] uppercase tracking-wider text-[#C6D3E1]/60">
                    Sender Name
                  </label>
                  <input
                    type="text"
                ...
                {/* Email */}
                <div className="flex flex-col gap-1.5">
                  <label htmlFor="email" className="font-mono text-[9px] uppercase tracking-wider text-[#C6D3E1]/60">
                ...
                <div className="flex flex-col gap-1.5">
                  <label htmlFor="projectType" className="font-mono text-[9px] uppercase tracking-wider text-[#C6D3E1]/60">
                ...
                {/* Message */}
                <div className="flex flex-col gap-1.5">
                  <label htmlFor="message" className="font-mono text-[9px] uppercase tracking-wider text-[#C6D3E1]/60">
              ...
              <AnimatePresence>
                {isSending && (
                  ...
                  >
                    ...
                    <span className="animate-pulse">ENCRYPTING DATA PACKETS //</span>
                    <span className="text-[10px] text-[#C6D3E1]/50 mt-1">ESTABLISHING SECURED NODE CONNECTION...</span>
                  </motion.div>
                )}
                ...
                {isSuccess && (
                  ...
                  >
                    ...
                    <span className="font-bold uppercase tracking-wider text-white">TRANSMISSION SENT SUCCESSFULLY</span>
                    <span className="text-[10px] text-[#C6D3E1]/60 mt-1.5 max-w-xs">
                      Our system logs have captured your specifications. A producer will ping your coordinates within 12 hours.
                    </span>
                  </motion.div>
                )}
              </AnimatePresence>
          ...
          <div className="lg:col-span-5 space-y-6">
            ...
            >
              <GlassCard className="p-5 bg-[#151D26]/60 border border-white/5 group-hover:border-green-500/30 transition-all">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <span className="block text-[8px] font-mono text-[#C6D3E1]/40 uppercase">DIRECT DISPATCH</span>
                    ...
                    <p className="text-[10px] text-[#C6D3E1]/70 mt-1 font-light">
                      Start an instant dialogue regarding budget scoping and timelines.
                    </p>
                  </div>
                </div>
              </GlassCard>
            ...
            {/* Widget 2: Email */}
            <a 
              href="mailto:production@vortexstudio.com" 
              className="block group cursor-pointer"
            >
              <GlassCard className="p-5 bg-[#151D26]/60 border border-white/5 group-hover:border-[#00D4FF]/30 transition-all">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <span className="block text-[8px] font-mono text-[#C6D3E1]/40 uppercase">E-MAIL DIRECTORY</span>
                    <h4 className="font-display font-bold text-sm text-white group-hover:text-[#00D4FF] transition-colors">
                      production@vortexstudio.com
                    </h4>
                    <p className="text-[10px] text-[#C6D3E1]/70 mt-1 font-light">
                      Send raw story briefs, video assets, or RFP dossiers directly.
                    </p>
                  </div>
                </div>
              </GlassCard>
            ...
            >
              <GlassCard className="p-5 bg-[#151D26]/60 border border-white/5 group-hover:border-[#6BB8FF]/30 transition-all">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <span className="block text-[8px] font-mono text-[#C6D3E1]/40 uppercase">CALENDAR_SCHEDULE</span>
                    <h4 className="font-display font-bold text-sm text-white group-hover:text-[#6BB8FF] transition-colors">
                      Book a Production Call
                    </h4>
                    <p className="text-[10px] text-[#C6D3E1]/70 mt-1 font-light">
                      Schedule a 15-minute briefing session on Google Meet.
                    </p>
                  </div>
                </div>
              </GlassCard>
